...
{
    private static readonly byte[] UtfBom = [0xEF, 0xBB, 0xBF,];
    ...
    private void ParseAndEmitLine(int currentLine, ReadOnlySpan<byte> line)
    {
    ...
    private static bool NeedEscapeValueForKey(ParsedRobotsKey key)
    {
        ...
        {
            ParsedRobotsKey.KeyType.UserAgent or ParsedRobotsKey.KeyType.Sitemap => false,
            _ => true,
        };
    }
